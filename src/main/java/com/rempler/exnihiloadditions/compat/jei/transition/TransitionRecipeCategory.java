package com.rempler.exnihiloadditions.compat.jei.transition;
...
public class TransitionRecipeCategory implements IRecipeCategory<TransitionRecipe> {
    ...
    public static final ResourceLocation UID =
            ResourceLocation.fromNamespaceAndPath(ExNihiloConstants.ModIds.EX_NIHILO_SEQUENTIA, "transition");
