package com.rempler.exnihiloadditions.compat.jei.precipitate;
...
public class PrecipitateRecipeCategory implements IRecipeCategory<PrecipitateRecipe> {
    ...
    public static final ResourceLocation UID =
            ResourceLocation.fromNamespaceAndPath(ExNihiloConstants.ModIds.EX_NIHILO_SEQUENTIA, "precipitate");
