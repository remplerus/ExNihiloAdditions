package com.rempler.exnihiloadditions.compat.jei.solidifying;
...
public class SolidifyingRecipeCategory implements IRecipeCategory<SolidifyingRecipe> {
    ...
    public static final ResourceLocation UID =
            ResourceLocation.fromNamespaceAndPath(ExNihiloConstants.ModIds.EX_NIHILO_SEQUENTIA, "solidifying");
