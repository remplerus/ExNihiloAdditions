...
public class CustomBarrelBlock extends WoodBarrelBlock {

    public CustomBarrelBlock(Properties properties) {
        super(properties);
    }
    ...
    public void setPlacedBy(@NotNull Level level, @NotNull BlockPos pos, @NotNull BlockState state,
        ...
        if (!variantId.isEmpty() && level.getBlockEntity(pos) instanceof CustomBarrelBlockEntity be) {
