...
//
    ...
    //                    BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath(modid, "wood/lumber/"+blockName)),
    //                    BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath(modid, "wood/planks/"+blockName+"_slab")),
    //                    modid);
    ...
    //                    BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath(modid, "wood/planks/"+blockName)),
    //                    BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath(modid, "wood/planks/"+blockName+"_slab")),
    //                    modid);
    ...
    //}
//
    //public static void createOreRecipes(RecipeOutput consumer) {
    ...
    //        } else {
    //            if (ore.isGraded()) {
    //                SiftingRecipeBuilder.sifting(Items.GRAVEL, BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath(modid, "ore/poor_" + ore.name().toLowerCase())))
    //                    .addRoll(new MeshWithChance(MeshType.FLINT, 0.1f))
    //                    .build(consumer.withConditions(modLoaded(modid)), ExNihiloAdditions.rl(modid+"/sifting/poor/" + ore.name().toLowerCase()));
    //                SiftingRecipeBuilder.sifting(Items.SAND, BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath(modid, "ore/normal_" + ore.name().toLowerCase())))
    //                    .addRoll(new MeshWithChance(MeshType.FLINT, 0.1f))
    //                    .build(consumer.withConditions(modLoaded(modid)), ExNihiloAdditions.rl(modid+"/sifting/normal/" + ore.name().toLowerCase()));
    //                SiftingRecipeBuilder.sifting(EXNBlocks.DUST.asItem(), BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath(modid, "ore/rich_" + ore.name().toLowerCase())))
    //                    .addRoll(new MeshWithChance(MeshType.FLINT, 0.1f))
    //                    .build(consumer.withConditions(modLoaded(modid)), ExNihiloAdditions.rl(modid+"/sifting/rich/" + ore.name().toLowerCase()));
    //            } else {
    //                SiftingRecipeBuilder.sifting(Items.GRAVEL, BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath(modid, "ore/" + ore.name().toLowerCase())))
    //                    .addRoll(new MeshWithChance(MeshType.FLINT, 0.1f))
    //                    .build(consumer.withConditions(modLoaded(modid)), ExNihiloAdditions.rl(modid+"/sifting/" + ore.name().toLowerCase()));
    //            }
    //        }
    //    }
    //}
//
    //private static void createOreToTFC(RecipeOutput consumer, Ore ore, Item item) {
    //    ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, BuiltInRegistries.ITEM.get(ResourceLocation.fromNamespaceAndPath(modid, "gem/" + ore.name().toLowerCase())))
    //        .requires(item)
    ...
    //        .save(consumer.withConditions(modLoaded(modid)), ResourceLocation.fromNamespaceAndPath(ExNihiloAdditions.MODID, modid+"/sandpaper/vanilla_to_tfc_"+ore.name().toLowerCase()));
    //}
}
