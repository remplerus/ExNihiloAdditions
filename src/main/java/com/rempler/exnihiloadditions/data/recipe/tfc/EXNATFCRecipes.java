        ...
        ConditionalRecipe.builder().addCondition(modLoaded(modid))
                .addRecipe(recipe ->
                        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, BuiltInRegistries.ITEM.get(new ResourceLocation(modid, "gem/" + ore.name().toLowerCase())))
                                ...
                                .save(recipe, new ResourceLocation(ExNihiloAdditions.ModIds.MODID, modid+"/sandpaper/vanilla_to_tfc_"+ore.name().toLowerCase()))
                )
                .generateAdvancement()
                .build(consumer, new ResourceLocation(ExNihiloAdditions.ModIds.MODID, modid+"/sandpaper/vanilla_to_tfc_"+ore.name().toLowerCase()));
    }
}
